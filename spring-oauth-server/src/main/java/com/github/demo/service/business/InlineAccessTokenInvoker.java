...
public abstract class InlineAccessTokenInvoker implements InitializingBean {
    ...
    protected transient AuthenticationManager authenticationManager = SpringBeanHolder.getBean(AuthenticationManager.class);

    protected transient AuthorizationServerTokenServices tokenServices = SpringBeanHolder.getBean(AuthorizationServerTokenServices.class);
    ;
    protected transient ClientDetailsService clientDetailsService = SpringBeanHolder.getBean(ClientDetailsService.class);
