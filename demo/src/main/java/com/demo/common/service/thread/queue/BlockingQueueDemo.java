...
public class BlockingQueueDemo {
     ...
     * <p>
     * SynchronousQueue:
     * LinkedTransferQueue:TransferQueue继承了BlockingQueue; 生产者会一直阻塞直到所添加到队列的元素被某一个消费者所消费（不仅仅是添加到队列里就完事）。
     * *                    新添加的transfer方法用来实现这种约束。顾名思义，阻塞就是发生在元素从一个线程transfer到另一个线程的过程中，它有效地实现了元素在线程之间的传递
     * <p>
     * 方法:
     * * peek
     * * element
