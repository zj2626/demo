...
import com.demo.common.service.mysql.dal.mapper.ShipperEntranceSettingMapper;
import com.demo.common.service.mysql.dal.model.ShipperEntranceSetting;
import com.demo.common.service.mysql.dal.model.ShipperEntranceSettingExample;
    ...
    public void test1() {
        try {
            ...
            for (String requestType : requestTypes) {
                ...
                List<ShipperEntranceSetting> shipperEntranceSettings = shipperEntranceSettingMapper.selectByExample(example);
                if (CollectionUtils.isEmpty(shipperEntranceSettings)) {
                    ShipperEntranceSetting setting = new ShipperEntranceSetting();
                    ...
                    ShipperEntranceSetting setting = shipperEntranceSettings.get(0);
                    setting.setRequestType(requestType);
                    setting.setCustomerId(cusomerId);
                    setting.setUnpickup(true);
                    setting.setSiteUnpickup(true);
