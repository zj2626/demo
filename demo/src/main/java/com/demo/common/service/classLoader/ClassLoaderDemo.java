...
public class ClassLoaderDemo {
    ...
    public void test() {
        ...
        try {
            Class clazz = classLoader.loadClass("com.demo.common.service.classLoader.bean.UserA");
    ...
    public void test2() throws ClassNotFoundException, IllegalAccessException, InstantiationException {
        ...
        // 方法一
//        Class<?> clazz = Class.forName("com.demo.common.service.classLoader.bean.UserA", true, classLoader);
        // 方法二
        Class<?> clazz = classLoader.loadClass("com.demo.common.service.classLoader.bean.UserA");
