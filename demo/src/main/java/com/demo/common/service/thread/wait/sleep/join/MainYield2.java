...
public class MainYield2 {
    public static void main(String[] args) throws InterruptedException {
        ...
        MainWait.PrinterNum printerNum = new MainWait.PrinterNum();
...
//        t2.join();
    ...
    static class RunClass9 implements Runnable {
        private MainWait.PrinterNum printerNum;

        public RunClass9(MainWait.PrinterNum printerNum) {
...
//        printerNum.printA();
    ...
    static class RunClass10 implements Runnable {
        private MainWait.PrinterNum printerNum;

        public RunClass10(MainWait.PrinterNum printerNum) {
            this.printerNum = printerNum;
        }
...
//        printerNum.printB();
    ...
    static class RunClass11 implements Runnable {
        private MainWait.PrinterNum printerNum;

        public RunClass11(MainWait.PrinterNum printerNum) {
            this.printerNum = printerNum;
        }
