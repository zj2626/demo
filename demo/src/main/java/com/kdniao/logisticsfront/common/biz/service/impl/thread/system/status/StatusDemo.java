package com.kdniao.logisticsfront.common.biz.service.impl.thread.system.status;
 ...
 * 5. 超时等待(TIMED_WAITING)：该状态不同于WAITING，它可以在指定的时间后自行返回。   [wait(long),join(long),sleep(long),LockSupport.parkUntil(),LockSupport.parkNanos()]
...
public class StatusDemo {
    ...
    public void test3() {
        ...
        new Thread(new BlockDemo(), "block-0").start();
        new Thread(new BlockDemo(), "block-1").start();
    }
