 ...
 * @since 2.0.1
 */
public class SpringBeanHolder implements BeanFactoryAware, InitializingBean {

    private static final Logger LOG = LoggerFactory.getLogger(SpringBeanHolder.class);
    ...
    public void setBeanFactory(BeanFactory beanFactory) throws BeansException {
        SpringBeanHolder.beanFactory = beanFactory;
    }
